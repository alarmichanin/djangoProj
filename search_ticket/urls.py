...
from search_ticket.views import (
    get_home_page, AvaluableRouts, AboutView, TestimonialsView,
    FeaturesView, TeamView, PricingView, ContactsView
)

urlpatterns = [
    
    path("", get_home_page, name="home"),
    path("routs_for_user/<start>/<end>", AvaluableRouts.as_view(), name="get_avaluable_routs"),
